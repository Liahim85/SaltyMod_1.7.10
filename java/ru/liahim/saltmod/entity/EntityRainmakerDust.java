...
public class EntityRainmakerDust extends Entity {
    ...
    private int cloud = SaltConfig.cloudLevel.containsKey(this.worldObj.provider.dimensionId) ?
    		SaltConfig.cloudLevel.get(this.worldObj.provider.dimensionId) : 128;
