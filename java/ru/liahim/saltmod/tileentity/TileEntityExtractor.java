...
public class TileEntityExtractor extends TileEntity implements ISidedInventory, IFluidHandler {
    ...
    //tank
    private int maxCap = FluidContainerRegistry.BUCKET_VOLUME * SaltConfig.extractorVolume;
    ...
    public void pressure() {
        ...
        if (pressure >= 16) {
            ...
            this.worldObj.createExplosion((Entity) null, this.xCoord + 0.5D, this.yCoord + 0.5D, this.zCoord + 0.5D, 2.5F, true);
        }
    }
