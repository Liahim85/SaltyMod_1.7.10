...
public class SaltBlock extends Block {
    ...
    {
		if (meta < 0 || meta > 9){meta = 0;}
		
		if (meta == 1)
		{return this.CHISELED;}
		else if (meta == 2) {
			if (side < 2) {return this.LINESTOP;}
			else {return this.LINES;}}
		else if (meta == 3) {
			if (side > 3) {return this.LINESTOP;}
			else {return this.LINES;}}
		else if (meta == 4) {
			if (side == 2 || side == 3) {return this.LINESTOP;}
			else {return this.LINES;}}
		else if (meta == 5) {
			if (side == 1) {return this.BRICKTOP;}
			else if (side == 0) {return this.BRICKBOTTOM;}
			else {return this.BRICK;}}
		else if (meta == 6) {return this.BLOCKCRACKED;}
		else if (meta == 7) {
			if (side == 1) {return this.BRICKCRACKEDTOP;}
			else if (side == 0) {return this.BRICKCRACKEDBOTTOM;}
			else {return this.BRICKCRACKED;}}
		else if (meta == 8) {
			if (side == 1) {return this.BRICKCHISELEDTOP;}
			else if (side == 0) {return this.BRICKCHISELEDBOTTOM;}
			else {return this.BRICKCHISELED;}}
		else if (meta == 9) {
			if (side == 1) {return this.CHAPITERTOP;}
			else if (side == 0) {return this.LINESTOP;}
			else {return this.CHAPITER;}}
    ...
    {
    	this.blockIcon = par1.registerIcon("saltmod:SaltBlock");
    	this.CHISELED = par1.registerIcon("saltmod:SaltBlock_Chiseled");
    	this.LINES = par1.registerIcon("saltmod:SaltBlock_Lines");
    	this.LINESTOP = par1.registerIcon("saltmod:SaltBlock_Lines_Top");
    	this.BRICK = par1.registerIcon("saltmod:SaltBrick");
    	this.BRICKTOP = par1.registerIcon("saltmod:SaltBrick_Top");
    	this.BRICKBOTTOM = par1.registerIcon("saltmod:SaltBrick_Bottom");
    	this.BLOCKCRACKED = par1.registerIcon("saltmod:SaltBlock_Cracked");
    	this.BRICKCRACKED = par1.registerIcon("saltmod:SaltBrick_Cracked");
    	this.BRICKCRACKEDTOP = par1.registerIcon("saltmod:SaltBrick_Cracked_Top");
    	this.BRICKCRACKEDBOTTOM = par1.registerIcon("saltmod:SaltBrick_Cracked_Bottom");
    	this.BRICKCHISELED = par1.registerIcon("saltmod:SaltBrick_Chiseled");
    	this.BRICKCHISELEDTOP = par1.registerIcon("saltmod:SaltBrick_Chiseled_Top");
    	this.BRICKCHISELEDBOTTOM = par1.registerIcon("saltmod:SaltBrick_Chiseled_Bottom");
    	this.CHAPITER = par1.registerIcon("saltmod:SaltChapiter");
    	this.CHAPITERTOP = par1.registerIcon("saltmod:SaltChapiter_Top");
    }
